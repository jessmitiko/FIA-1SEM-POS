...
if __name__ == "__main__":
    ...
    for row in linhas:
        ...
        print(f'getting posicao of linha {cl}... ')
        response=requests.get(f'{base_url}/Posicao/Linha?codigoLinha={cl}', headers=headers)
        
        posicao=response.json()

        posicao['cl']=cl
        posicao_by_linha.append(posicao)

    path_s3='s3a://bronze/posicao_by_linha/'
    save_to_s3(path_s3, posicao_by_linha)